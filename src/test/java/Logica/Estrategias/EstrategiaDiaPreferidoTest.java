...
class EstrategiaDiaPreferidoTest {
    ...
    void setUp() {
        ...
        Profesor p2 = new Profesor("p2", "prof", "p2@mail.com", "p2", 2, 100000, Set.of(Asignatura.MATEMATICA), Set.of(Martes8AM));

        claseBuena = new Clase(p1, "C01", Asignatura.MATEMATICA, Lunes8AM);
        claseMala = new Clase(p2, "C02", Asignatura.MATEMATICA, Martes8AM);
